...
import { Bell, ArrowLeft, Search, Mail, CheckCircle2, Clock } from 'lucide-react';
...
export default function OrtuNotifikasiPage() {
    ...
    const fetchNotifikasi = async () => {
        ...
        try {
            ...
            // Get linked children to find relevant messages
    ...
    return (
        <div className="space-y-6 pb-20 animate-fade-in">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-xl font-bold text-slate-900 tracking-tight">Pesan & Info</h1>
                    <p className="text-xs text-slate-500 font-medium">Riwayat pengingat untuk anak Anda</p>
                </div>
            </div>
            ...
            {isLoading ? (
                ...
                <Card className="p-12 text-center">
                    ...
                    <p className="text-slate-400 text-xs max-w-[200px] mx-auto leading-relaxed">
                        Anda akan menerima pengingat otomatis di sini terkait jadwal posyandu dan imunisasi.
                    </p>
                </Card>
            ) : (
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        {notif.dikirim_at && (
                                            <span className="text-[9px] font-medium text-slate-400 italic">
                                                Dikirim {formatDate(notif.dikirim_at)}
                                            </span>
                                        )}
                                    </div>
                                </div>
